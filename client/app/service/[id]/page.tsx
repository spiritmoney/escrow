            ...
            <div className='w-11/12 mx-auto'>
                <div className="relative container bg-white rounded-xl mt-10 mx-auto min-w-full text-black">
                    ...
                    <div className="relative bg-white w-full p-7 rounded-xl flex items-center space-x-8">
                        ...
                        <button className="m-6 px-6 py-2 mx-auto bg-blue-700 flex items-center space-x-2 text-white rounded-lg">
                    ...
                    {booking &&
                        <div className='absolute bottom-5 inset-x-0 mx-auto z-50 bg-white border-2 border-gray-300 rounded-lg p-7 w-[550px] flex flex-col space-y-3'>
