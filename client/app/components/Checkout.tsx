        ...
        return(
            <div className="bg-white rounded-lg text-black w-[550px] p-10 flex flex-col space-y-2 items-center">
                ...
                <div className="flex items-center w-96 justify-between text-white py-3">
                    <button className="bg-red-700 p-2 w-44 rounded-lg">
                        Cancel
                    </button>
                    <button onClick={showAddress} className="bg-blue-600 p-2 w-44 rounded-lg">
                        Confirm
                    </button>
                </div>
            </div>
        ...
        return(
            <div className="bg-white rounded-lg text-black w-[550px] p-10 flex flex-col space-y-2 items-center">
                ...
                <div>
                    ...
                    <input type="text" className='w-96 border-2 border-gray-400 rounded-lg p-2'/>
                </div>
                <div>
